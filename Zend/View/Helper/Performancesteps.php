...
class Zend_View_Helper_Performancesteps extends Zend_View_Helper_Abstract
{
    public function performancesteps($perfArray)
    {
        ...
        <div class="per_steps">
            <ul class="toggle_ul">
                <li id="initstep_1" class="step_1 incomplete">
                    <div class="step_round">Step<span class="num_txt">1</span></div>
                ...
                <li id="initstep_2" class="step_2 incomplete">
                    <div class="step_round">Step<span class="num_txt">2</span></div>
                    <div class="left_tab_content">
                        <div class="completed_icon"></div>
                ...
                <li id="initstep_3" class="step_3 incomplete">
                    <div class="step_round">Step<span class="num_txt">3</span></div>
                    <div class="left_tab_content">
                        <div class="completed_icon"></div>
            ...
            <?php if (isset($perfArray['ratingsflag']) && $perfArray['ratingsflag'] == 'false') { ?>
                <div class='ml-alert-1-error' style="clear: both;position: relative;top: 17px;width: 92%;">
                    ...
                    Ratings not added for the appraisal. <a target="_blank"
                                                            href="<?php echo BASE_URL . 'appraisalratings/add' ?>"
                                                            style="color:#A31414;text-decoration: none;font-weight: bold;">Click
                        here</a> to configure ratings.
                </div>
            <?php } ?>
