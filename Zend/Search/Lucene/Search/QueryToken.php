...
class Zend_Search_Lucene_Search_QueryToken
{
     ...
     */
    const TC_WORD = 0;
    const TC_PHRASE = 1;   // Word
    const TC_NUMBER = 2;   // Phrase (one or several quoted words)
    const TC_SYNTAX_ELEMENT = 3;   // Nubers, which are used with syntax elements. Ex. roam~0.8
    /**
     * Token type.
     *
     * @var integer
