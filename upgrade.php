...
<head>
    ...
    <link href="<?php echo MEDIA_PATH; ?>jquery/css/cupertino/jquery-ui-1.8.16.custom.css" media="screen"
          rel="stylesheet" type="text/css">
    ...
    <div class="content_wrapper">
        ...
        if ($codeversion != '' && $dbversion != '' && $dbid != '' && $codeid != '') {
            ...
            <div class="upgrade-div">
                <div id='upgradedb'
                     onclick="upgradesystem('<?php echo WEBSERVICEURL; ?>','db','<?php echo $codeversion; ?>','<?php echo $dbversion; ?>')">
                    <span>UPGRADE DATABASE</span></div>
            </div>
        <?php }else if ($codeid < $dbid) { ?>
            ...
            <div class="upgrade-div">
                <div id='upgradecode'
                     onclick="upgradesystem('<?php echo WEBSERVICEURL; ?>','code','<?php echo $codeversion; ?>','<?php echo $dbversion; ?>')">
                    <span>UPGRADE CODE</span></div>
            </div>
        <?php } ?>
        ...
        <?php }else{
        ?>
            <div class="error_mess">Your application is not updated .Please check your internet connection to update or
                visit sentrifugo.com to update your system.
            </div>
        <?php } ?>
