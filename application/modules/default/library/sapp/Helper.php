        ...
        <div class="new-form-ui <?php echo $extra_class; ?>">
            ...
            <div class="division"><?php echo $form->$element; ?>
                <?php if (isset($msg_array[$element])) { ?>
                    <span class="errors"
                          id="errors-<?php echo $form->$element->getId(); ?>"><?php echo $msg_array[$element]; ?></span>
                <?php } ?>
                <?php
                if (count($popup_arr) > 0) {
                    ?>
                    <span class="add-coloum"
                          onclick="displaydeptform('<?php echo BASE_URL . $popup_arr['popup_url'] ?>','<?php echo $popup_arr['popup_disp_name']; ?>');"> <?php echo $popup_arr['popup_link_name']; ?> </span>
                    <?php
                }
                ?>
            </div>
        ...
        if ($sizeOfWorksheet > 1) {
            ...
            try {
                ...
                for ($i = 2; $i <= $sizeOfWorksheet; $i++) {
                    ...
                    $ex_email_arr[$i] = $rowData[5];
                    $ex_bu_arr[] = $rowData[6];
                    $ex_dep_arr[] = $rowData[7];
                    $ex_rm_arr[] = $rowData[8];
                    $ex_jt_arr[] = $rowData[9];
                    $ex_pos_arr[] = $rowData[10];
                    $ex_es_arr[] = $rowData[11];
                    $ex_doj_arr[] = $rowData[12];
                    $ex_dol_arr[] = $rowData[13];
                    $ex_exp_arr[] = $rowData[14];
                    $ex_ext_arr[] = $rowData[15];
                    $ex_wn_arr[] = $rowData[16];
                ...
                <ul class="dropdown">
                    ...
                    if ($loginuserRole == SUPERADMINROLE || $isOrgHead == '1') {
                        ...
                        <?php if ($empaddpermission == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/employee/add"><i class="icon-user"></i>Employee</a>
                            </li>
                        <?php } ?>


                        <?php if ($reqiaddpermission == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/requisition/add"><i
                                            class="icon-cog"></i>Requisition</a></li>
                        <?php } ?>


                        <?php if ($apprinitpermission == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/appraisalinit/add"><i class="icon-remove"></i>Appraisal</a>
                            </li>
                        <?php } ?>


                        <?php if ($bunitaddpermission == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/businessunits/edit"><i class="icon-cog"></i>Business
                                    Unit</a></li>
                        <?php } ?>


                        <?php if ($deptaddpermission == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/departments/edit"><i class="icon-remove"></i>Department</a>
                            </li>
                        <?php } ?>


                        <?php if ($announcementaddperm == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/announcements/add"><i class="icon-remove"></i>Announcement</a>
                            </li>
                        <?php } ?>
                        ...
                        <?php if ($leaveAddPerm == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/leaverequest/"><i class="icon-cog"></i>Leave
                                    Request</a></li>
                        <?php } ?>


                        <?php if (!empty($servReqAddPerm)) { ?>
                            <li><a href="<?php echo $baseUrl; ?>/servicerequests/add/t/pA=="><i class="icon-remove"></i>Service
                                    Request</a></li>
                        <?php } ?>
                    ...
                    <?php } elseif ($loginuserGroup == EMPLOYEE_GROUP) {
                        ...
                        <?php if ($leaveAddPerm == 'Yes') { ?>
                            <li><a href="<?php echo $baseUrl; ?>/leaverequest/"><i class="icon-remove"></i>Leave Request</a>
                            </li>
                        <?php } ?>
        ...
        if (!empty($leavesCountArray)) {
            ...
            <div class="count_new_dis_par">
                ...
                foreach ($leavesCountArray as $key => $value) {
                    //if($key!='all') {?>
                    <div id="filter_<?php echo $key; ?>" class="clickable_menu count_new_dis"
                         parent-div="div_mchilds_<?php echo EMPLOYEESELFSERVICE; ?>"
                         super-parent="main_parent_<?php echo EMPLOYEESELFSERVICE; ?>"
                         primary_parent="<?php echo LEAVES; ?>"
                         menu-url="<?php echo BASE_URL . 'pendingleaves/' . $key; ?>">
                        <?php //} else { ?>
                ...
                <div class="history-div">
                    ...
                    foreach ($incidentHistory as $history) {
                        ...
                        <div class="history-flow">
                            <div class="history-img"><img width="28" height="28" border="0"
                                                          src="<?php echo DOMAIN; ?>public/uploads/profile/<?php echo $history['emp_profile_img']; ?>"
                                                          onerror="this.src='<?php echo MEDIA_PATH; ?>images/profile_pic.png'"/>
                            </div>
                            <div class="history-text">
                                <span><?php echo trim($history['history']); ?></span><b><?php echo sapp_Global::change_date($history['hdate'], 'view'); ?><?php echo sapp_Global::getDisplaySDTime($history['htime']); ?></b>
                            </div>
                        </div>
                        <?php
                    }
