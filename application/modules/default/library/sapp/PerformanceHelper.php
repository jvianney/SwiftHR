...
class sapp_PerformanceHelper
{
    ...
    public static function questions_privileges($questionarray, $appraisalid, $checkArr, $initializationdata)
    {
        ...
        <div id="hiddenquestiondiv" style="display:none;" class="qstnscrldiv">
            <div class="total-form-controller_" id="childqsdiv">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear: both; margin-top: 0px;"
                       id="questiontable" class="requisition-table employee_appraisal-table">
                    <tr>
        ...
        <div id="questiondiv" class="qstnscrldiv">
            ...
            <div class="total-form-controller_" id="parentqsdiv">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="clear:both;margin-top: 0px;"
                       class="requisition-table employee_appraisal-table">
                    <tr>
                        <th class="check_field"><input type="checkbox" class="selectallcls" name="selectall"
                                                       value="selectall" id="selectall">Check All
                        </th>
                        <th class="question_field">Questions</th>
                        <th class="field_width">
                            <div class="comments_div_fiel"><input type="checkbox" class="mgrcmntcls" name="mgrcmnt"
                                                                  value="" id="mgrcmnt">Manager Comments
                            </div>
                            <div class="comments_div_fiel"><input type="checkbox" class="mgrratingcls" name="mgrrating"
                                                                  value="" id="mgrrating">Manager Ratings
                            </div>
                            <div class="comments_div_fiel"><input type="checkbox" class="empcmntcls" name="empcmnt"
                                                                  value="" id="empcmnt">Employee Comments
                            </div>
                            <div class="comments_div_fiel"><input type="checkbox" class="empratingcls" name="empratings"
                                                                  value="" id="empratings">Employee Ratings
                            </div>
                        </th>
                    </tr>
                    <?php foreach ($questionarray as $key => $question) {
                        ...
                        <tr id="questiontr_<?php echo $question['id']; ?>">
                            <td class="check_field"><input type="checkbox" class="checkallcls"
                                                           ques_id="<?php echo $question['id']; ?>"
                                                           id="check_<?php echo $question['id']; ?>" name="check[]"
                                                           value="<?php echo $question['id']; ?>" <?php echo $check; ?>
                                                           onclick="checkchildtd(this)"></td>
                            ...
                            <td class="field_width">
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="mgrcmntcls qprivileges_<?php echo $question['id']; ?>"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="mgrcmnt_<?php echo $question['id']; ?>"
                                                                      name="mgrcmnt[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $mgrcheck; ?>
                                                                      onclick="checkparenttd(this)">Manager Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="mgrratingcls qprivileges_<?php echo $question['id']; ?>"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="mgrrating_<?php echo $question['id']; ?>"
                                                                      name="mgrrating[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $mgrrate; ?>
                                                                      onclick="checkparenttd(this)">Manager Ratings
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="empcmntcls qprivileges_<?php echo $question['id']; ?>"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="empcmnt_<?php echo $question['id']; ?>"
                                                                      name="empcmnt[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $empcmntcheck; ?>
                                                                      onclick="checkparenttd(this)">Employee Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="empratingcls qprivileges_<?php echo $question['id']; ?>"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="empratings_<?php echo $question['id']; ?>"
                                                                      name="empratings[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $empratcheck; ?>
                                                                      onclick="checkparenttd(this)">Employee Ratings
                                </div>
                            </td>
                ...
                <input type="hidden" id="initializestep" name="initializestep"
                       value="<?php echo $initializationdata['initialize_status']; ?>">
                <input type="hidden" id="questioncount" name="questioncount"
                       value="<?php echo sizeof($questionarray); ?>">
            </div>
        </div>
        ...
        <div class="new-form-ui-submit" id="qssubmitdiv">
            <?php if ($initializationdata['initialize_status'] == 1) { ?>
                <button name="submitbutton" id="submitbuttons" type="button" onclick="saveInitilize(3)">Update
                    Initialization
                </button>
            <?php } else { ?>
                <button name="submitbutton" id="submitbuttons" type="button" onclick="saveInitilize(1)">Save &
                    Initialize
                </button>
                <button name="submitbutton" id="submitbuttons" type="button" onclick="saveInitilize(2)">Save &
                    Initialize Later
                </button>
                <button name="submitbutton" id="submitbuttons" type="button"
                        onclick="changesettings('0','<?php echo $appraisalid ?>')">Discard
                </button>
            <?php } ?>
        ...
        <div id="qspopupdiv" style="display: none; ">
            ...
            <div class="total-form-controller">
                ...
                <div id="contentdiv">
                    ...
                    <div class="new-form-ui ">
                        <label class="required">Question <img class="tooltip"
                                                              title="Special characters allowed are - ? ' . , / # @ $ & * ( ) !"
                                                              src="<?php echo MEDIA_PATH; ?>images/help.png"></label>
                        <div class="division">
                            <input type="text" onkeyup="validatequestionname(this)" onblur="validatequestionname(this)"
                                   name="question_id" id="question_id" value="" maxlength="100">
                        </div>
                    </div>
    ...
    public static function employee_group_questions_privileges($groupEmployeeCountArr, $appraisalid, $initializationdata, $dispflag)
    {
        ...
        <div style="clear: both;position: relative;top: 17px;width: 92%;" class="ml-alert-1-info" id="msg_div">
            ...
            Once appraisal process is initialized and employees start filling their appraisals, questions cannot be
            added or edited.
        </div>
    <?php } ?>
        <div class="width_98">
                ...
                foreach ($groupEmployeeCountArr as $key => $val) {
                    ...
                    <div class="groupeddiv" id="groupdiv_<?php echo $val['id']; ?>">
                        <div class="groupnamediv"
                             id="groupname_<?php echo $val['id']; ?>"><?php echo $val['group_name']; ?></div>
                        <div class="empcountdiv">Employees <span class="count"><?php echo $val['empcount']; ?></span>
                        </div>
                        <div class="qscountdiv">Questions <span class="count"><?php echo $val['qscount']; ?></span>
                        </div>

                        <div id="hoverdiv_<?php echo $val['id']; ?>" class="grphoverclass">
                            <ul>
                                <?php if ($initializationdata['initialize_status'] == 1) { ?>
                                    <li onclick='viewempgroup("<?php echo $val['group_name']; ?>","<?php echo $val['group_id']; ?>","<?php echo $appraisalid; ?>","<?php echo $val['empcount']; ?>");'>
                                        View
                                    </li>
                                    <?php if ($dispflag == 'edit') { ?>
                                        <li onclick='editgroupemp("<?php echo $val['group_name']; ?>","<?php echo $val['group_id']; ?>","<?php echo $appraisalid; ?>","<?php echo $val['empcount']; ?>");'>
                                            Edit
                                        </li>
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php if ($dispflag == 'edit') { ?>
                                        ...
                                        <li onclick='deletegroupemp("<?php echo $val['group_id']; ?>","<?php echo $appraisalid; ?>","<?php echo $val['id']; ?>");'>
                                            Delete
                                        </li>
                                    <?php }
                                } ?>
            ...
            <?php if (isset($initializationdata['empcount']) && $initializationdata['empcount'] > 0) { ?>
                <?php if ($dispflag != 'view') { ?>
                    ...
                    <div class="new-form-ui-submit" style="margin-left: 0px;">
                        <div class="create_new_group" onclick="creategroupemp('<?php echo $appraisalid; ?>')"
                             style="margin-left: 0px; height: 17px;">Create New Group
                        </div>
                        <button name="submitbutton" id="submitbuttons" class="discard_button" type="button"
                                onclick="changesettings('0','<?php echo $appraisalid ?>')">Discard
                        </button>
                    </div>
                <?php } ?>
        ...
        <div class="new-form-ui-submit" id="initialization_div">
            <?php if ($initializationdata['initialize_status'] == 1) { ?>
                <?php if ($dispflag != 'view' && $dispflag != 'display') { ?>
                    <button name="submitbutton" id="submitbuttons" type="button"
                            onclick="saveGroupInitilize(1,'<?php echo $appraisalid ?>')">Update Initialization
                    </button>
                <?php } ?>
            ...
            <?php } else { ?>
                <?php if ($dispflag == 'edit') { ?>
                    <?php if ($initializationdata['empcount'] == 0 && !empty($groupEmployeeCountArr)) { ?>
                        <button name="submitbutton" id="submitbuttons" class="init_class" type="button"
                                onclick="saveGroupInitilize(1,'<?php echo $appraisalid ?>')">Initialize
                        </button>
                        <button name="submitbutton" id="submitbuttons" class="init_class_later" type="button"
                                onclick="saveGroupInitilize(2,'<?php echo $appraisalid ?>')">Initialize Later
                        </button>
                        <button name="submitbutton" id="submitbuttons" class="discard_button" type="button"
                                onclick="changesettings('0','<?php echo $appraisalid ?>')">Discard
                        </button>
    ...
    public static function questions_privileges_view($questionarray, $appraisalid, $checkArr, $initializationdata)
    {
        ...
        <ul class="tabs_all_button">
            <li id="selecteddiv" class="active" style="cursor: default;">Questions</li>
        </ul>
        <div id="questiondiv" class="qstnscrldiv">
            <div class="total-form-controller_">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                       style="clear: both; margin-top: 0px; width: 97%;"
                       class="requisition-table employee_appraisal-table">
                    <tr>
                        <th class="question_field">Questions</th>
                        <th class="field_width">
                    ...
                    foreach ($questionarray as $key => $question) {
                        ...
                        <tr id="questiontr_<?php echo $question['id']; ?>">
                            ...
                            <td class="field_width">
                                <div class="comments_div_fiel"><input type="checkbox" class="mgrcmntcls"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="mgrcmnt_<?php echo $question['id']; ?>"
                                                                      name="mgrcmnt[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $mgrcheck; ?> disabled>Manager
                                    Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox" class="mgrratingcls"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="mgrrating_<?php echo $question['id']; ?>"
                                                                      name="mgrrating[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $mgrrate; ?> disabled>Manager
                                    Ratings
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox" class="empcmntcls"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="empcmnt_<?php echo $question['id']; ?>"
                                                                      name="empcmnt[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $empcmntcheck; ?> disabled>Employee
                                    Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox" class="empratingcls"
                                                                      ques_id="<?php echo $question['id']; ?>"
                                                                      id="empratings_<?php echo $question['id']; ?>"
                                                                      name="empratings[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $empratcheck; ?> disabled>Employee
                                    Ratings
                                </div>
                            </td>
                        </tr>
    ...
    public static function ff_questions_privileges($questionarray, $checkArr)
    {
            ...
            <div class="users_list" style="width: 100%;">
                ...
                <div id="hiddenquestiondiv" style="display:none;" class="qstnscrldiv">
                    <div class="total-form-controller" id="childqsdiv">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                               style="clear: both; width: 100%; margin-top: 0px;" id="questiontable"
                               class="requisition-table employee_appraisal-table">
                            <tr>
                                <th class="question_field">Questions</th>
                                <th class="field_width">
                ...
                <div id="questiondiv" class="qstnscrldiv">
                    ...
                    <div class="total-form-controller_" id="parentqsdiv">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                               style="clear: both; width: 100%;margin-top: 0px;"
                               class="requisition-table employee_appraisal-table">
                            <tr>
                                <th class="check_field" width="10%"><input type="checkbox" class="selectallcls"
                                                                           name="selectall" value="selectall"
                                                                           id="selectall">Check All
                                </th>
                                <th class="question_field" width="33%">Questions</th>
                                <th class="field_width" width="57%">
                                    <div class="comments_div_fiel"><input type="checkbox" class="empcmntcls"
                                                                          name="empcmnt" value="" id="empcmnt">Comments
                                    </div>
                                    <div class="comments_div_fiel"><input type="checkbox" class="empratingcls"
                                                                          name="empratings" value="" id="empratings"
                                                                          checked disabled>Ratings
                                    </div>
                                </th>
                            </tr>
                            <?php foreach ($questionarray as $key => $question) {
                                ...
                                <tr id="questiontr_<?php echo $question['id']; ?>">
                                    <td class="check_field"><input type="checkbox" class="checkallcls"
                                                                   ques_id="<?php echo $question['id']; ?>"
                                                                   id="check_<?php echo $question['id']; ?>"
                                                                   name="check[]"
                                                                   value="<?php echo $question['id']; ?>" <?php echo $check; ?>
                                                                   onclick="checkchildtd(this)"></td>
                                    <td class="question_field" id="queshtml_<?php echo $question['id']; ?>">
                                    ...
                                    <td class="field_width">
                                        <div class="comments_div_fiel"><input type="checkbox"
                                                                              ...
                                                                              name="empcmnt[<?php echo $question['id']; ?>]"
                                                                              value="1" <?php echo $empcmntcheck; ?>
                                                                              onclick="checkparenttd(this)">Comments
                                        </div>
                                        <div class="comments_div_fiel"><input type="checkbox"
                                                                              class="empratingcls qprivileges_<?php echo $question['id']; ?>"
                                                                              ques_id="<?php echo $question['id']; ?>"
        ...
        <div class="new-form-ui-submit" style="margin-top: 40px;">
            ...
            <button name="submitbutton" id="submitbuttons" type="button" onclick="saveInitilize(1)">Save & Initialize
            </button>
            <button name="submitbutton" id="submitbuttons" type="button" onclick="saveInitilize(2)">Save & Initialize
                Later
            </button>
            <button onclick="window.location.href='<?php echo BASE_URL; ?>feedforwardinit';" type="button" id="Cancel"
                    name="Cancel">Cancel
            </button>
        </div>
    ...
    public static function ff_questions_privileges_view($questionarray, $checkArr, $saveFlag = '')
    {
        ...
        <ul class="tabs_all_button" style="margin-left: 0px;">
            <li id="selecteddiv" class="active" style="cursor: default; background: none repeat scroll 0% 0% #fff;">
                Questions
            </li>
        </ul>
        <div id="questiondiv" class="qstnscrldiv per_steps"
             style="overflow: hidden; padding-bottom: 0px; margin-bottom: 20px;">


            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                   style="clear: both; width: 100%; margin-top: 0px; margin-bottom: 0px;"
                   class="requisition-table employee_appraisal-table">
                <tr>
                    ...
                    <tr id="questiontr_<?php echo $question['id']; ?>">
                        ...
                        <td class="field_width">
                            <div class="comments_div_fiel"><input type="checkbox" class="empcmntcls"
                                                                  ...
                                                                  id="empcmnt_<?php echo $question['id']; ?>"
                                                                  name="empcmnt[<?php echo $question['id']; ?>]"
                                                                  value="1" <?php echo $empcmntcheck; ?> disabled>Comments
                            </div>
                            <div class="comments_div_fiel"><input type="checkbox" class="empratingcls"
                                                                  ques_id="<?php echo $question['id']; ?>"
                                                                  id="empratings_<?php echo $question['id']; ?>"
                                                                  name="empratings[<?php echo $question['id']; ?>]"
                                                                  value="1" <?php echo $empratcheck; ?> disabled>Ratings
                            </div>
                        </td>
                    </tr>
                    <?php
    ...
    public static function manager_questions_privileges($questionarray, $appraisalid, $checkArr, $initializationdata)
    {
        ...
        <div id="hiddenquestiondiv" style="display:none;" class="qstnscrldiv">
            <div class="total-form-controller" id="childqsdiv">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                       style="clear: both; margin-top: 0px; width: 100%;" id="questiontable"
                       class="requisition-table employee_appraisal-table">
                    <tr>
                        <th class="question_field">Questions</th>
                        <th class="field_width">
        ...
        <div id="questiondiv" class="qstnscrldiv">
            <div class="total-form-controller_" id="parentqsdiv">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                       style="clear: both; margin-top: 0px; width: 100%;"
                       class="requisition-table employee_appraisal-table">
                    <tr>
                        <th class="check_field"><input type="checkbox" class="selectallcls" name="selectall"
                                                       value="selectall" id="selectall">Check All
                        ...
                        <th class="field_width">
                            ...
                            <div class="comments_div_fiel" style="width:45%;"><input type="checkbox" class="empcmntcls"
                                                                                     name="empcmnt" value=""
                                                                                     id="empcmnt">Employee Comments
                            </div>
                            <div class="comments_div_fiel"><input type="checkbox" class="empratingcls" name="empratings"
                                                                  value="" id="empratings">Employee Ratings
                            </div>
                    ...
                    <?php foreach ($questionarray as $key => $question) {
                        ...
                        <tr id="questiontr_<?php echo $question['id']; ?>">
                            ...
                            <td class="field_width">
                                ...
                                <div class="comments_div_fiel" style="width:45%;"><input type="checkbox"
                                                                                         class="empcmntcls qprivileges_<?php echo $question['id']; ?>"
                                                                                         ques_id="<?php echo $question['id']; ?>"
                                                                                         id="empcmnt_<?php echo $question['id']; ?>"
                                                                                         name="empcmnt[<?php echo $question['id']; ?>]"
                                                                                         value="1" <?php echo $empcmntcheck; ?>
                                                                                         onclick="checkmgrparenttd(this)">Employee
                                    Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="empratingcls qprivileges_<?php echo $question['id']; ?>"
                                                                      ...
                                                                      name="empratings[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $empratcheck; ?>
                                                                      onclick="checkmgrparenttd(this)">Employee Ratings
                                </div>
                            </td>
            ...
            <div class="total-form-controller">
                ...
                <div id="contentdiv">
                    ...
                    <div class="new-form-ui-submit">
                        ...
                        <input type="button" value="Save" id="submitqs" name="submitqs"
                               onclick="savemanagerquestions()"/>
    ...
    public static function manager_questions_privileges_view($questionarray, $appraisalid, $checkArr, $initializationdata)
    {
        ...
        <ul class="tabs_all_button" style="margin-left: 0px;">
            <li id="selecteddiv" class="active" style="cursor: default;">Configured Questions</li>
        </ul>
        <div id="questiondiv" class="qstnscrldiv">
            <div class="total-form-controller">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr id="questiontr_<?php echo $question['id']; ?>">
                            ...
                            <td class="field_width">
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      ...
                                                                      name="mgrcmnt[<?php echo $question['id']; ?>]"
                                                                      value="1" <?php echo $mgrcheck; ?>
                                                                      onclick="checkparenttd(this)" disabled>Manager
                                    Comments
                                </div>
                                <div class="comments_div_fiel"><input type="checkbox"
                                                                      class="mgrratingcls qprivileges_<?php echo $question['id']; ?>"
        ...
        <div class="new-form-ui-submit" id="qssubmitdiv">
            <button onclick="window.location.href='<?php echo BASE_URL; ?>appraisalinit';" type="button" id="Cancel"
                    name="Cancel">Cancel
            </button>
        </div>
        <div class="clear"></div>
        ...
        <div id="ratingsdiv" class="ratings_div" style="display: none;">
            ...
            for ($i = 0; $i < $ratingsstar; $i++) {
                ...
                <div class="ratings_block">
                    <span id="ratingstar_<?php echo $i + 1; ?>"
                          class="<?php echo $ratingclass . ($i + 1); ?>"><?php echo $i + 1; ?></span>
                    <span id="ratingtext_<?php echo $i + 1; ?>"
                          class="<?php echo $ratingtextclass . ($i + 1); ?>"><?php echo $ratingsarr[$i]['rating_text']; ?> </span>
                </div>
                <?php
            }
            ?>
            ...
            <div class="total-form-controller">
                ...
                <div id="contentdiv_multi">
                    ...
                    <div class="new-form-ui-submit" style="width: auto; clear: none; margin-top: 37px;">
                        ...
                        <button name="Cancel" id="Cancel" type="button" onclick="$('#skillsdiv').dialog('close');">
                            Cancel
                        </button>
            ...
            <div class="total-form-controller" style="clear: both;">
                ...
                <div id="contentdiv">
                    <div class="new-form-ui ">
                        <label class="required">Skill</label>
                        <div class="division">
                            <input type="text" maxlength="30" value="" id="skill_name" name="skill_name"
                                   onkeyup="validateskillname(this,2)" onblur="validateskillname(this,2)">
                        </div>
                    </div>
    ...
    public static function appraisal_status_dropdown($statusArr, $flag)
    {
        ...
        <div class="new-form-ui" id="statusdiv">
            <label>Appraisal Status <img class="tooltip" title="Select business unit and check the status"
                                         src="<?php echo DOMAIN . 'public/media/'; ?>images/help.png"></label>
            <button type="button" id="appraisalstatusclear" name="appraisalstatusclear" class="inputclear"
                    style="display:none;" onclick="clearappstatus('<?php echo $flag; ?>')">Clear
            </button>
            <div class="division">
                <select id="appraisal_status" name="appraisal_status"
                        onchange="displappstatus('<?php echo $flag; ?>',this.value)">
        ...
        <div class="new-form-ui" id="statusdiv">
            <label>Manager Appraisal Status
                <?php if (isset($loginuserGroup) && $loginuserGroup != HR_GROUP) { ?>
                    <img class="tooltip" title="Select business unit and check the status"
                         src="<?php echo DOMAIN . 'public/media/'; ?>images/help.png">
                <?php } ?>
            </label>
            <button type="button" id="appraisalstatusclear" name="appraisalstatusclear" class="inputclear"
                    style="display:none;" onclick="clearappstatus('<?php echo $flag; ?>')">Clear
            ...
            <div class="division">
                <select id="appraisal_status" name="appraisal_status"
                        onchange="displmanagerappstatus('<?php echo $flag; ?>',this.value)">
                    <option value="">Select Appraisal Status</option>
