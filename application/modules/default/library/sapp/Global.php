...
class sapp_Global
{
    ...
    public static function usermenu_html($menu_id, $parent_menu_id1, $parent_menu_id2, $display, $permission_data, $chk_disabled = null, $default_permissions)
    {
        ...
        $i = 0;
        ?>
        <div id="idcls_checkboxes_<?php echo $menu_id; ?>"
             class="cls_radiobuttons_div cls_radiobuttons_div<?php echo $menu_id; ?> <?php echo $parent_class_div1; ?> <?php echo $parent_class_div2; ?>"
