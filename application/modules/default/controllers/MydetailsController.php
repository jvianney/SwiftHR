            ...
            if ($type != "") {
                ...
                switch ($type) {
                    ...
                    case 3:    //Disability
                        ...
                        if ($injury_name == "") {
                            //Error
                            $msgarray['injury_name'] = 'Please enter the disability.';
                            $errFlag++;
                        }
                        if ($insurer_name == "") {
                            $msgarray['insurer_name'] = "Please enter the insurer name.";
                        ...
                        if ($disability_type == "") {
                            $msgarray['disability_type'] = 'Please select a disability type.';
                            $errFlag++;
                        }
                    ...
                    case 4:        //Injury
                        ...
                        if ($injury_name == "") {
                            //Error
                            $msgarray['injury_name'] = 'Please enter the injury.';
                            $errFlag++;
                        }
                        if ($injury_severity == "") {
                            //Error
                            $msgarray['injury_severity'] = 'Please select an injury severity.';
                            $errFlag++;
                        }
                        if ($insurer_name == "") {
                            $msgarray['insurer_name'] = "Please enter the medical insurer name.";
                            $errFlag++;
                        }
                        if ($expected_date_join == "") {
                            $msgarray['expected_date_join'] = 'Please select a date.';
