...
?>
<form method="post" action="index.php?s=<?php echo sapp_Global::_encrypt(4); ?>" id="step4" name="step4"
      class="frm_install">
    ...
    <div class="content_part">
        ...
        <div class="new-form-ui ">
            <label class="required">Authentication Type<img src="images/help.png"
                                                            title="authentication to access mail account (ex: true/false)"
                                                            class="tooltip"></label>
            <div>
                <?php
        ...
        <div id="mailAuthDiv" style="display:<?php echo $display; ?>">
            <div class="new-form-ui ">
                <label class="required">User name<img src="images/help.png"
                                                      title="Mail Server username provided during Mail Server account setup."
                                                      class="tooltip"></label>
                <div>
                    <input type="text" maxlength="100" value="<?php if (!$_POST) {
                        echo defined('MAIL_USERNAME') ? MAIL_USERNAME : '';
                    } else {
                        echo $_POST['username'];
            ...
            <div class="new-form-ui ">
                <label class="required">Password<img src="images/help.png"
                                                     title="Mail Server password provided during Mail Server account setup."
                                                     class="tooltip"></label>
                <div>
                    <input type="password" maxlength="100" value="<?php if (!$_POST) {
                        echo defined('MAIL_PASSWORD') ? MAIL_PASSWORD : '';
                    } else {
                        echo $_POST['password'];
        ...
        <div class="new-form-ui ">
            <label class="required">SMTP Server<img src="images/help.png"
                                                    title="IP address of your hosting account as your Mail Server hostname (ex: mail.google.com)"
                                                    class="tooltip"></label>
            <div>
                <input type="text" maxlength="100" value="<?php if (!$_POST) {
                    echo defined('MAIL_SMTP') ? MAIL_SMTP : '';
                } else {
                    echo $_POST['smtpserver'];
        ...
        <div class="new-form-ui ">
            <label>Secure Transport Layer<img src="images/help.png"
                                              title="Provides communication security over internet (ex: tls)"
                                              class="tooltip"></label>
            <div>
                <input type="text" maxlength="40" value="<?php if (!$_POST) {
                    echo defined('MAIL_TLS') ? MAIL_TLS : '';
                } else {
                    echo $_POST['tls'];
                } ?>" id="tls" name="tls">
        ...
        <div class="new-form-ui ">
            <label class="required">Port<img src="images/help.png"
                                             title="Port number to access SMTP server (Ex: 22, 25)"
                                             class="tooltip"></label>
            <div>
                <input type="text" maxlength="50" value="<?php if (!$_POST) {
                    echo defined('MAIL_PORT') ? MAIL_PORT : '';
                } else {
                    echo $_POST['port'];
                } ?>" id="port" name="port">
    ...
    <button name="previous" id="previous" type="button" class="previous_button"
            onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(3); ?>';">Previous
    </button>
    <?php if (defined('MAIL_SMTP') && defined('MAIL_USERNAME') && defined('MAIL_PASSWORD') && defined('MAIL_PORT') && defined('MAIL_TLS')) { ?>
        <button name="next" id="next" type="button"
                onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(5); ?>';">Next
        </button>
    <?php } ?>
