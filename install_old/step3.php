...
<form id="idstep3" name="frmstep3" method="post" action="index.php?s=<?php echo sapp_Global::_encrypt(3); ?>"
      class="frm_install">
    ...
    <div class="content_part">
        ...
        <div class="new-form-ui ">
            <label class="required">Application Name<img src="images/help.png" title="Name of your application."
                                                         class="tooltip"></label>
            <div>
        ...
        <div class="new-form-ui ">
            <label class="required">Email<img src="images/help.png"
                                              title="Super admin email for authenticate Mail Server."
                                              class="tooltip"></label>
            <div>
    ...
    <button name="previous" id="previous" class="previous_button" type="button"
            onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(2); ?>';">Previous
    </button>
    <?php if (defined('APPLICATION_NAME') && defined('SUPERADMIN_EMAIL') && constant('SUPERADMIN_EMAIL') != '') { ?>
        <button name="next" id="next" type="button"
                onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(4); ?>';">Next
        </button>
    <?php } ?>
</form>
