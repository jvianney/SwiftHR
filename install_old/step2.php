...
<form method="post" action="index.php?s=<?php echo sapp_Global::_encrypt(2); ?>" id="step2" name="step2"
      class="frm_install">
    ...
    <div class="content_part">
        ...
        <div class="new-form-ui ">
            <label class="required">Host<img src="images/help.png"
                                             title="IP address of your hosting account as your MySQL hostname."
                                             class="tooltip"></label>
            <div>
                <input type="text" maxlength="40" value="<?php if (!$_POST) {
                    echo defined('SENTRIFUGO_HOST') ? SENTRIFUGO_HOST : '';
                } else {
                    echo $_POST['host'];
                } ?>" id="host" name="host">
        ...
        <div class="new-form-ui ">
            <label class="required">User Name<img src="images/help.png"
                                                  title="Database Server username provided during MySQL account setup."
                                                  class="tooltip"></label>
            <div>
                <input type="text" maxlength="50" value="<?php if (!$_POST) {
                    echo defined('SENTRIFUGO_USERNAME') ? SENTRIFUGO_USERNAME : '';
                } else {
                    echo $_POST['username'];
        ...
        <div class="new-form-ui ">
            <label>Password<img src="images/help.png"
                                title="Database Server password provided during MySQL account setup."
                                class="tooltip"></label>
            <div>
                <input type="password" maxlength="50" value="<?php if (!$_POST) {
                    echo defined('SENTRIFUGO_PASSWORD') ? SENTRIFUGO_PASSWORD : '';
                } else {
                    echo $_POST['password'];
        ...
        <div class="new-form-ui ">
            <label class="required">Database Name<img src="images/help.png"
                                                      title="Create a database and provide the name of the database here."
                                                      class="tooltip"></label>
            <div>
                <input type="text" maxlength="50" value="<?php if (!$_POST) {
                    echo defined('SENTRIFUGO_DBNAME') ? SENTRIFUGO_DBNAME : '';
                } else {
                    echo $_POST['dbname'];
    ...
    <button name="previous" id="previous" class="previous_button" type="button"
            onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(1); ?>';">Previous
    </button>
    <?php if (defined('SENTRIFUGO_HOST') && defined('SENTRIFUGO_USERNAME') && defined('SENTRIFUGO_PASSWORD') && defined('SENTRIFUGO_DBNAME')) { ?>
        <button name="next" id="next" type="button"
                onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(3); ?>';">Next
        </button>
    <?php } ?>
