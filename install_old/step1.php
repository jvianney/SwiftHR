...
<form name="frmstep1" id="frmstep1" method="post" action="" class="frm_install">
        ...
        <ul class="progress">
            ...
            foreach ($req_arr as $req => $req_value) {
                ...
                <li>
                    ...
                    <?php if ($req_value == 0) { ?>
                        <?php if ($req == 'php') { ?>
                            <a href="<?php echo PHPURL; ?>" target="_blank" style="text-decoration: none;">
                                <div class="error-txt" id="phplink">Current php version does not comply with
                                    installation process.
                                </div>
                            </a>
                        <?php } else if ($req == 'pdo_mysql') { ?>
                            <a href="<?php echo PDOURL; ?>" target="_blank" style="text-decoration: none;">
                                <div class="error-txt" id="phplink">PDO-Mysql extension is disabled in your php.ini
                                    file.
                                </div>
                            </a>
                        <?php } else if ($req == 'gd') { ?>
                            <a href="<?php echo GDURL; ?>" target="_blank" style="text-decoration: none;">
                                <div class="error-txt" id="phplink">GD Library module is disabled in your php.ini
                                    file.
                                </div>
                            </a>
                        <?php } else if ($req == 'openssl') { ?>
                            <a href="<?php echo OPENSSLURL; ?>" target="_blank" style="text-decoration: none;">
                                <div class="error-txt" id="phplink">Open SSL module is disabled in your php.ini file.
                                </div>
                            </a>
                        <?php }
                    } ?>
        ...
        <ul class="progress">
            ...
            if (count($with_permission) > 0) {
                ...
                foreach ($with_permission as $path) {
                    ?>
                    <li>
                        <div class="folderstructure"><?php echo $path; ?></div>
    ...
    if ($cnt == 0) {
        ...
        <button name="next" id="next" type="button"
                onclick="window.location='index.php?s=<?php echo sapp_Global::_encrypt(2); ?>';">Next
        </button>
        <?php
    }
