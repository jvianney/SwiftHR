                                    ...
                                    if (postdata.id == "_empty") {
                                        ...
                                        if (rp_ge.reloadAfterSubmit) {
                                            ...
                                            if (!rp_ge.closeAfterEdit) {
                                                setTimeout(function () {
                                                    $($t).jqGrid("setSelection", postdata.id);
                                                }, 1000);
                                            }
                                        } else {
        ...
        navGrid: function (elem, o, pEdit, pAdd, pDel, pSearch, pView) {
            ...
            return this.each(function () {
                ...
                if ($("#" + alertIDs.themodal).html() == null) {
                    ...
                    createModal(alertIDs, "<div>" + o.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {
                        gbox: "#gbox_" + $t.p.id,
                        jqModal: true,
                        drag: true,
                        resize: true,
